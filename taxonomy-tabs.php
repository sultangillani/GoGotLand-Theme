...
*/
	...
	$checktax = get_queried_object();
	$tax = $checktax->taxonomy;
	$slug = $checktax->slug;
	...
	$get_post = get_post($slider_post_all_id[0]);
...
<div class="che_sections_contain">
...
<section class="section_three" id="section_three">
  <div class="container konferens">
    ...
    <div class="row">
      ...
      <div class="col-sm-12 <?php if($tax == 'tabs'){ echo 'd-flex'; } ?>" id="joel_filters_id" style="<?php if($tax != 'tabs'){ echo 'display: none;'; } ?>">
						...
						if($key != 0){
							?>
								<li class="nav-item" key="<?php echo $key; ?>">
									<a class="nav-link joel_filter_btn d-flex justify-content-center align-items-center <?php if( $tax == 'tabs' && $slug == $tab->slug ){ echo 'active'; } ?>" id="<?php echo $tab->slug; ?>-tab" data-toggle="tab" href="#<?php echo $tab->slug; ?>" role="tab" aria-controls="<?php echo $tab->slug; ?>" aria-selected="true"><?php echo $tab->name; ?></a>
								</li>
							<?php
						}
					}
    ...
    <div class="tab-content" id="myTabContent">
					<?php
						foreach($tabs_terms as $key => $tab){
								...
								<div class="tab-pane fade <?php if( $tax == 'tabs' && $slug == $tab->slug ){ echo 'active'; } ?>" id="<?php echo $tab->slug; ?>" style="<?php if( $tax == 'tabs' && $slug == $tab->slug ){ echo 'opacity: 1;'; } ?>" >
